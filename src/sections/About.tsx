      ...
      <div className="relative mx-auto max-w-content section-padding">
        ...
        <Reveal className="mx-auto mt-10 max-w-3xl" delay={0.08}>
          <div className="space-y-5 text-center text-base leading-relaxed text-secondary sm:text-lg">
            <p>
              Через 70 лет цифровая капсула времени откроется для нового
              поколения жителей Обнинска.
            </p>
            <p>
        ...
        <motion.div
          ...
          className="relative mx-auto mt-20 max-w-2xl text-center sm:mt-24"
        >
          <div
            aria-hidden
          ...
          <div className="relative space-y-5">
            <p className="font-display text-xl leading-snug text-text sm:text-2xl">
              Возможно, через 70 лет кто-то откроет капсулу и прочитает именно
              ваши слова.
            </p>
