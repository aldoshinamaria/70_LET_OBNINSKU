...
export function BackgroundDecor() {
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden" aria-hidden>
      ...
      <div className="absolute right-[-10%] top-1/3 h-[380px] w-[380px] rounded-full bg-primary/5 blur-[120px]" />
      <div className="absolute bottom-[-10%] left-[-5%] h-[420px] w-[420px] rounded-full bg-success/5 blur-[140px]" />
      <div
