...
Если после сброса первое послание получило номер **19** вместо **1**, выполните [`supabase/fix-message-numbers.sql`](./supabase/fix-message-numbers.sql) — оно станет **000001**, следующие пойдут по порядку.
